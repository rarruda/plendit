...
### Profile
Profile.create({"id"=>"1", "name"=>"Jan Erik Berentsen", "phone_number"=>"99994444", "join_timestamp"=>"2015-03-25 23:33:00 UTC", "last_action_timestamp"=>"2015-03-25 23:33:00 UTC", "private_link_to_facebook"=>"", "private_link_to_linkedin"=>"", "ephemeral_answer_percent"=>"25", "profile_status_id"=>"2", "email"=>"jan.erik.berentsen@plendit.com.testonly", "password_digest"=>"$2a$10$Ri6zUs6f/eYk9hxN7TXGL.sM8O9pL8pYZThKe4gYfHz66IJaaYUHu"})
Profile.create({"id"=>"2", "name"=>"Trygve Leite", "phone_number"=>"44449999", "join_timestamp"=>"2015-03-25 23:34:00 UTC", "last_action_timestamp"=>"2015-03-25 23:34:00 UTC", "private_link_to_facebook"=>"", "private_link_to_linkedin"=>"", "ephemeral_answer_percent"=>"75", "profile_status_id"=>"2", "email"=>"trygve.leite@plendit.com.testonly", "password_digest"=>"$2a$10$/q5b3stbLBf.IUAjlRReR..J4H1iChiwV9jKbIldcAGp580H/hZsi"})
Profile.create({"id"=>"3", "name"=>"Fredrik", "phone_number"=>"99998888", "join_timestamp"=>"2015-03-25 23:34:00 UTC", "last_action_timestamp"=>"2015-03-25 23:34:00 UTC", "private_link_to_facebook"=>"", "private_link_to_linkedin"=>"", "ephemeral_answer_percent"=>"", "profile_status_id"=>"2","email"=>"fredrik@testonly", "password_digest"=>"foobar"})
Profile.create({"id"=>"4", "name"=>"Nina", "phone_number"=>"44442222", "join_timestamp"=>"2015-03-25 23:34:00 UTC", "last_action_timestamp"=>"2015-03-25 23:34:00 UTC", "private_link_to_facebook"=>"", "private_link_to_linkedin"=>"", "ephemeral_answer_percent"=>"", "profile_status_id"=>"2","email"=>"nina@testonly", "password_digest"=>"foobar"})
Profile.create({"id"=>"5", "name"=>"Bjarte", "phone_number"=>"95554444", "join_timestamp"=>"2015-03-25 23:35:00 UTC", "last_action_timestamp"=>"2015-03-25 23:35:00 UTC", "private_link_to_facebook"=>"", "private_link_to_linkedin"=>"", "ephemeral_answer_percent"=>"", "profile_status_id"=>"2","email"=>"bjarte@pestonly", "password_digest"=>"foobar"})
Profile.create({"id"=>"6", "name"=>"Kjell Einar", "phone_number"=>"99995555", "join_timestamp"=>"2015-04-04 15:45:00 UTC", "last_action_timestamp"=>"2015-04-04 15:45:00 UTC", "private_link_to_facebook"=>"", "private_link_to_linkedin"=>"", "ephemeral_answer_percent"=>"75", "profile_status_id"=>"2","email"=>"kjell@testonly", "password_digest"=>"foobar"})
Profile.create({"id"=>"7", "name"=>"Åse", "phone_number"=>"44441111", "join_timestamp"=>"2015-04-04 15:45:00 UTC", "last_action_timestamp"=>"2015-04-04 15:45:00 UTC", "private_link_to_facebook"=>"", "private_link_to_linkedin"=>"", "ephemeral_answer_percent"=>"95", "profile_status_id"=>"2","email"=>"aase@testonly", "password_digest"=>"foobar"})
Profile.create({"id"=>"8", "name"=>"Jon Arne", "phone_number"=>"94947777", "join_timestamp"=>"2015-04-04 15:46:00 UTC", "last_action_timestamp"=>"2015-04-04 15:46:00 UTC", "private_link_to_facebook"=>"", "private_link_to_linkedin"=>"", "ephemeral_answer_percent"=>"60", "profile_status_id"=>"2","email"=>"jon@testonly", "password_digest"=>"foobar"})
Profile.create({"id"=>"9", "name"=>"Ove", "phone_number"=>"99996767", "join_timestamp"=>"2015-04-04 15:47:00 UTC", "last_action_timestamp"=>"2015-04-04 15:47:00 UTC", "private_link_to_facebook"=>"", "private_link_to_linkedin"=>"", "ephemeral_answer_percent"=>"57", "profile_status_id"=>"2","email"=>"ove@testonly", "password_digest"=>"foobar"})
Profile.create({"id"=>"10", "name"=>"Aina", "phone_number"=>"44448787", "join_timestamp"=>"2015-04-04 15:48:00 UTC", "last_action_timestamp"=>"2015-04-04 15:48:00 UTC", "private_link_to_facebook"=>"", "private_link_to_linkedin"=>"", "ephemeral_answer_percent"=>"100", "profile_status_id"=>"1","email"=>"aina@testonly", "password_digest"=>"foobar"})
Profile.create({"id"=>"11", "name"=>"Nils", "phone_number"=>"44448888", "join_timestamp"=>"2015-04-04 15:49:00 UTC", "last_action_timestamp"=>"2015-04-04 15:49:00 UTC", "private_link_to_facebook"=>"", "private_link_to_linkedin"=>"", "ephemeral_answer_percent"=>"62", "profile_status_id"=>"2","email"=>"nils@testonly", "password_digest"=>"foobar"})
Profile.create({"id"=>"12", "name"=>"Olav", "phone_number"=>"44445454", "join_timestamp"=>"2015-04-04 15:49:00 UTC", "last_action_timestamp"=>"2015-04-04 15:49:00 UTC", "private_link_to_facebook"=>"", "private_link_to_linkedin"=>"", "ephemeral_answer_percent"=>"42", "profile_status_id"=>"2","email"=>"olav@testonly", "password_digest"=>"foobar"})
Profile.create({"id"=>"13", "name"=>"Eline", "phone_number"=>"44999944", "join_timestamp"=>"2015-04-04 15:50:00 UTC", "last_action_timestamp"=>"2015-04-04 15:50:00 UTC", "private_link_to_facebook"=>"", "private_link_to_linkedin"=>"", "ephemeral_answer_percent"=>"34", "profile_status_id"=>"2","email"=>"eline@testonly", "password_digest"=>"foobar"})
Profile.create({"id"=>"14", "name"=>"Gunnar", "phone_number"=>"44442244", "join_timestamp"=>"2015-04-04 15:50:00 UTC", "last_action_timestamp"=>"2015-04-04 15:50:00 UTC", "private_link_to_facebook"=>"", "private_link_to_linkedin"=>"", "ephemeral_answer_percent"=>"84", "profile_status_id"=>"2","email"=>"gunnar@testonly", "password_digest"=>"foobar"})
...
### Feedback
Feedback.create({"id"=>"1", "ad_id"=>"1", "from_profile_id"=>"3", "score"=>"5", "body"=>"En god allround pulk som både jeg og min kone lett kan dra til tross for mye bagasje! Pris,\r\nkvalitet og utleier er det ingenting å utsette på. Anbefales. "})
Feedback.create({"id"=>"2", "ad_id"=>"1", "from_profile_id"=>"4", "score"=>"5", "body"=>"Jan Erik møtte opp til avtalt tid og produktet stemte godt overens med annonsen. En fantastisk\r\ngod pulk som både minstemann og forelde var veldig fornøyd med og som vi veldig gjerne leier\r\nigjen. Anbefales til alle som ikke har plass hjemme og som samtidig ønsker en pulk av god\r\nkvalitet til en lav pris! "})
Feedback.create({"id"=>"3", "ad_id"=>"1", "from_profile_id"=>"5", "score"=>"4", "body"=>"Leter du etter en god, lett pulk av god kvalitet, er dette den må du leie. Produktet er helt i tråd\r\nmed annonse-beskrivelsen og til tross for en liten misforståelse fra min side, har jeg ingen\r\nproblem med å anbefale både Jan Erik og pulken til andre. Tommel opp! "})
Feedback.create({"id"=>"4", "ad_id"=>"2", "from_profile_id"=>"3", "score"=>"5", "body"=>"En veldig god skiboks som passet perfekt på bilen vår. Trygve hadde universalfester som vi også\r\nfikk låne uten ekstra kostnad. Fantastisk service og et veldig godt produkt. Anbefales. "})
Feedback.create({"id"=>"5", "ad_id"=>"2", "from_profile_id"=>"4", "score"=>"5", "body"=>"Vi hadde dessverre ikke mulighet til å hente boksen, men det var ingen problem for utleier. Han\r\ntok den med seg til oss og hjelp til med monteringen. Vi kommer garantert til å leie fra Trygve\r\nigjen! "})
Feedback.create({"id"=>"6", "ad_id"=>"2", "from_profile_id"=>"1", "score"=>"5", "body"=>"Anbefales da jeg ikke har noe å utsette verken på annonsen eller utleier. "})
