Rails.application.configure do
  ...
  # to enable some caching for cdn/clients:
  config.static_cache_control = "public, max-age=#{6.hours.to_i}"
  ...
  # Already set to :redis_store in config/application.rb:
  # Use a different cache store in production.
  # config.cache_store = :mem_cache_store

  # Enable serving of images, stylesheets, and JavaScripts from an asset server.
  # config.action_controller.asset_host = 'http://assets.example.com'
  #config.action_controller.asset_host = 'https://cdn.plendit.com'
  # ^^ breaks image assets... cant really reconfigure either as same path is used in S3 for image buckets.
