...
json.main_payin_rule do
  json.total_fee @ad.booking_calculator.total_fee(@ad.main_payin_rule)
  json.max_insurance_coverage @ad.booking_calculator.max_insurance_coverage(@ad.main_payin_rule)
  json.payout_amount @ad.booking_calculator.payout_amount(@ad.main_payin_rule)
  json.payin_amount @ad.booking_calculator.payin_amount(@ad.main_payin_rule)
end
json.payin_rules do
